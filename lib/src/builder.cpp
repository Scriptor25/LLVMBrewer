...
Brewer::Builder::Builder(const std::string& name)
{
    m_Context = LLVMContextCreate();
    m_IRBuilder = LLVMCreateBuilderInContext(m_Context);
    m_Module = LLVMModuleCreateWithNameInContext(name.c_str(), m_Context);
...
Brewer::ValuePtr Brewer::Builder::GenEQ(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    ...
    if (type->IsInt())
    {
        ...
        return RValue::Direct(Type::Get("i1"), result);
    }
    if (type->IsFloat())
    {
...
Brewer::ValuePtr Brewer::Builder::GenNE(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenLT(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenGT(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenLE(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenGE(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenLAnd(const ValuePtr& lhs, const ValuePtr& rhs) const
{
...
Brewer::ValuePtr Brewer::Builder::GenLOr(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto l = LLVMBuildIsNotNull(m_IRBuilder, lhs->Get(), "");
    const auto r = LLVMBuildIsNotNull(m_IRBuilder, rhs->Get(), "");
...
Brewer::ValuePtr Brewer::Builder::GenLXor(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto l = LLVMBuildIsNotNull(m_IRBuilder, lhs->Get(), "");
    const auto r = LLVMBuildIsNotNull(m_IRBuilder, rhs->Get(), "");
...
Brewer::ValuePtr Brewer::Builder::GenAdd(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
    ...
    if (type->IsInt())
    {
        ...
        return RValue::Direct(type, result);
    }
    if (type->IsFloat())
    {
...
Brewer::ValuePtr Brewer::Builder::GenSub(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenMul(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenDiv(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenRem(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenAnd(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenOr(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenXor(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenShl(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenShr(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
...
Brewer::ValuePtr Brewer::Builder::GenAShr(const ValuePtr& lhs, const ValuePtr& rhs) const
{
    const auto type = lhs->GetType();
